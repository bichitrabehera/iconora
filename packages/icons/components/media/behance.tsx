...
import { behanceIconData } from "../../data/media/behance.data"

export const BehanceIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    {
      size = 24,
      color = "currentColor",
    ...
    const anims: AnimDef[] = [
        { selector: ".bh-b", keyframes: { scale: [1, 1.03, 1] }, options: { duration: 1.6, ease: "easeInOut", repeat: Infinity } }
      ]
    ...
    return (
      ...
      >
        ...
        <g className="bh-b" style={{ transformOrigin: "12px 12px" }}>
