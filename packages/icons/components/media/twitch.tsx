...
import { twitchIconData } from "../../data/media/twitch.data"

export const TwitchIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    {
      size = 24,
      color = "currentColor",
    ...
    const anims: AnimDef[] = [
        { selector: ".tw-chat", keyframes: { y: [0, -1.5, 0] }, options: { duration: 1.3, ease: "easeInOut", repeat: Infinity } }
      ]
    ...
    return (
      ...
      >
        ...
        <g className="tw-chat" style={{ transformOrigin: "12px 12px" }}>
