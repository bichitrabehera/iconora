...
import { dribbbleIconData } from "../../data/media/dribbble.data"

export const DribbbleIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    {
      size = 24,
      color = "currentColor",
    ...
    const anims: AnimDef[] = [
        { selector: ".db-ball", keyframes: { y: [0, -2, 0] }, options: { duration: 1.5, ease: "easeInOut", repeat: Infinity } }
      ]
    ...
    return (
      ...
      >
        ...
        <g className="db-ball" style={{ transformOrigin: "12px 12px" }}>
