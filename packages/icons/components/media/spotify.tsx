...
import { spotifyIconData } from "../../data/media/spotify.data"

export const SpotifyIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    {
      size = 24,
      color = "currentColor",
    ...
    const anims: AnimDef[] = [
        { selector: ".sp-wave", keyframes: { scale: [1, 1.03, 1] }, options: { duration: 1.5, ease: "easeInOut", repeat: Infinity } }
      ]
    ...
    return (
      ...
      >
        ...
        <g className="sp-wave" style={{ transformOrigin: "12px 12px" }}>
