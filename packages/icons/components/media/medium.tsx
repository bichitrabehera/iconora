...
import { mediumIconData } from "../../data/media/medium.data"
...
export const MediumIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    const anims: AnimDef[] = [
        { selector: ".md-m", keyframes: { y: [0, -1.5, 0] }, options: { duration: 1.4, ease: "easeInOut", repeat: Infinity } }
      ]
    ...
    return (
      ...
      >
        ...
        <g className="md-m" style={{ transformOrigin: "12px 12px" }}>
