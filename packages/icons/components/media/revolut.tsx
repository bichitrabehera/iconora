...
import { revolutIconData } from "../../data/media/revolut.data"

export const RevolutIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    {
      size = 24,
      color = "currentColor",
    ...
    const anims: AnimDef[] = [
        { selector: ".rv-r", keyframes: { rotate: [-2, 2, -2] }, options: { duration: 2, ease: "easeInOut", repeat: Infinity } }
      ]
    ...
    return (
      ...
      >
        ...
        <g className="rv-r" style={{ transformOrigin: "12px 12px" }}>
