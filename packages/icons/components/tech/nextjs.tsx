...
import { nextjsIconData } from "../../data/tech/nextjs.data"

export const NextjsIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    {
      size = 24,
      color = "currentColor",
    ...
    const stop = useCallback(async () => {
      controls.current.forEach((c) => c.stop())
      controls.current = []
      animate(".nj-arrow", { x: 0, y: 0 }, { duration: 0.25 })
    }, [animate])
    ...
    return (
      ...
      >
        ...
        <motion.path className="nj-arrow" d="M15 12v-3" style={{ transformOrigin: "15px 10.5px" }} />
      </motion.svg>
    )
  },
)
