...
import { flutterIconData } from "../../data/framework/flutter.data"

export const FlutterIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    {
      size = 24,
      color = "currentColor",
    ...
    const anims: AnimDef[] = [
        { selector: ".fl-step", keyframes: { x: [0, 1.5, 0] }, options: { duration: 1.2, ease: "easeInOut", repeat: Infinity } }
      ]
    ...
    return (
      ...
      >
        ...
        <g className="fl-step" style={{ transformOrigin: "12px 12px" }}>
