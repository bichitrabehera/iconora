...
import { phpIconData } from "../../data/framework/php.data"

export const PhpIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    {
      size = 24,
      color = "currentColor",
    ...
    const anims: AnimDef[] = [
        { selector: ".ph-elephant", keyframes: { scale: [1, 1.03, 1] }, options: { duration: 1.8, ease: "easeInOut", repeat: Infinity } }
      ]
    ...
    return (
      ...
      >
        ...
        <g className="ph-elephant" style={{ transformOrigin: "12px 12px" }}>
