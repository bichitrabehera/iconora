...
import { html5IconData } from "../../data/framework/html5.data"

export const Html5Icon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    {
      size = 24,
      color = "currentColor",
    ...
    const anims: AnimDef[] = [
        { selector: ".h5-badge", keyframes: { y: [0, -1.5, 0] }, options: { duration: 1.5, ease: "easeInOut", repeat: Infinity } }
      ]
    ...
    return (
      ...
      >
        ...
        <g className="h5-badge" style={{ transformOrigin: "12px 12px" }}>
