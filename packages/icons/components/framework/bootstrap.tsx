...
import { bootstrapIconData } from "../../data/framework/bootstrap.data"

export const BootstrapIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    {
      size = 24,
      color = "currentColor",
    ...
    const anims: AnimDef[] = [
        { selector: ".bs-bracket", keyframes: { scale: [1, 1.03, 1] }, options: { duration: 1.6, ease: "easeInOut", repeat: Infinity } }
      ]
    ...
    return (
      ...
      >
        ...
        <g className="bs-bracket" style={{ transformOrigin: "12px 12px" }}>
