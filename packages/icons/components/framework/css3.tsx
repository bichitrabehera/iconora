...
import { css3IconData } from "../../data/framework/css3.data"

export const Css3Icon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    {
      size = 24,
      color = "currentColor",
    ...
    const anims: AnimDef[] = [
        { selector: ".cs-badge", keyframes: { y: [0, -1.5, 0] }, options: { duration: 1.5, ease: "easeInOut", repeat: Infinity } }
      ]
    ...
    return (
      ...
      >
        ...
        <g className="cs-badge" style={{ transformOrigin: "12px 12px" }}>
