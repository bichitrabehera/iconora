...
import { kotlinIconData } from "../../data/framework/kotlin.data"

export const KotlinIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    {
      size = 24,
      color = "currentColor",
    ...
    const anims: AnimDef[] = [
        { selector: ".kt-fold", keyframes: { rotate: [0, 2, -2, 0] }, options: { duration: 2, ease: "easeInOut", repeat: Infinity } }
      ]
    ...
    return (
      ...
      >
        ...
        <g className="kt-fold" style={{ transformOrigin: "12px 12px" }}>
