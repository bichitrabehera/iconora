...
import { tetrisIconData } from "../../data/game/tetris.data"

export const TetrisIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    {
      size = 24,
      color = "currentColor",
    ...
    const stop = useCallback(async () => {
      controls.current.forEach((c) => c.stop())
      controls.current = []
      animate(".tet-col", { y: 0 }, { duration: 0.15 })
    }, [animate])
    ...
    return (
      <motion.svg
        ...
        className={className}
      >
        <motion.path className="tet-row" d="M8 7h8v2H8z" />
        <motion.path
          className="tet-col"
          d="M11 9h2v6h-2z"
