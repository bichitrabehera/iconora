...
import { androidIconData } from "../../data/os/android.data"

export const AndroidIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    {
      size = 24,
      color = "currentColor",
    ...
    const anims: AnimDef[] = [
        { selector: ".ad-bug", keyframes: { y: [0, -1.5, 0] }, options: { duration: 1.3, ease: "easeInOut", repeat: Infinity } }
      ]
    ...
    return (
      ...
      >
        ...
        <g className="ad-bug" style={{ transformOrigin: "12px 12px" }}>
        <path d="M4 10l0 6" />
        <path d="M20 10l0 6" />
