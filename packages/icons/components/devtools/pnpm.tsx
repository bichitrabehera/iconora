...
import { pnpmIconData } from "../../data/devtools/pnpm.data"

export const PnpmIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    {
      size = 24,
      color = "currentColor",
    ...
    const anims: AnimDef[] = [
        { selector: ".pn-grid", keyframes: { scale: [1, 1.04, 1] }, options: { duration: 1.6, ease: "easeInOut", repeat: Infinity } }
      ]
    ...
    return (
      ...
      >
        ...
        <g className="pn-grid" style={{ transformOrigin: "12px 12px" }}>
