...
import { viteIconData } from "../../data/devtools/vite.data"

export const ViteIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    {
      size = 24,
      color = "currentColor",
    ...
    const anims: AnimDef[] = [
        { selector: ".vt-bolt", keyframes: { scale: [1, 1.05, 1] }, options: { duration: 1.2, ease: "easeInOut", repeat: Infinity } }
      ]
    ...
    return (
      ...
      >
        ...
        <g className="vt-bolt" style={{ transformOrigin: "12px 12px" }}>
