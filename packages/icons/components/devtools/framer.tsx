...
import { framerIconData } from "../../data/devtools/framer.data"

export const FramerIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    {
      size = 24,
      color = "currentColor",
    ...
    const anims: AnimDef[] = [
        { selector: ".fm-fold", keyframes: { y: [0, -2, 0] }, options: { duration: 1.3, ease: "easeInOut", repeat: Infinity } }
      ]
    ...
    return (
      ...
      >
        ...
        <path className="fm-fold" d="M6 15h12l-12 -12h12v6h-12v6l6 6v-6" style={{ transformOrigin: "12px 12px" }} />
      </motion.svg>
    )
  },
)
