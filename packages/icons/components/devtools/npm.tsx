...
import { npmIconData } from "../../data/devtools/npm.data"

export const NpmIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    {
      size = 24,
      color = "currentColor",
    ...
    const anims: AnimDef[] = [
        { selector: ".np-box", keyframes: { scale: [1, 1.03, 1] }, options: { duration: 1.5, ease: "easeInOut", repeat: Infinity } }
      ]
    ...
    return (
      ...
      >
        ...
        <g className="np-box" style={{ transformOrigin: "12px 12px" }}>
