...
import { gitlabIconData } from "../../data/devtools/gitlab.data"

export const GitlabIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    {
      size = 24,
      color = "currentColor",
    ...
    const anims: AnimDef[] = [
        { selector: ".gl-tent", keyframes: { rotate: [-2, 2, -2] }, options: { duration: 2, ease: "easeInOut", repeat: Infinity } }
      ]
    ...
    return (
      ...
      >
        ...
        <path className="gl-tent" d="M21 14l-9 7l-9 -7l3 -11l3 7h6l3 -7l3 11" style={{ transformOrigin: "12px 14px" }} />
      </motion.svg>
    )
  },
)
