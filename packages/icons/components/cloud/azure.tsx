...
import { azureIconData } from "../../data/cloud/azure.data"

export const AzureIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    {
      size = 24,
      color = "currentColor",
    ...
    const anims: AnimDef[] = [
        { selector: ".az-stack", keyframes: { y: [0, -1.5, 0] }, options: { duration: 1.8, ease: "easeInOut", repeat: Infinity } }
      ]
    ...
    return (
      ...
      >
        ...
        <g className="az-stack" style={{ transformOrigin: "12px 12px" }}>
