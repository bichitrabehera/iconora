...
import { supabaseIconData } from "../../data/cloud/supabase.data"

export const SupabaseIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    {
      size = 24,
      color = "currentColor",
    ...
    const anims: AnimDef[] = [
        { selector: ".sb-zap", keyframes: { y: [0, -2, 0], rotate: [0, 2, -2, 0] }, options: { duration: 1.4, ease: "easeInOut", repeat: Infinity } }
      ]
    ...
    return (
      ...
      >
        ...
        <path className="sb-zap" d="M4 14h8v7l8 -11h-8v-7l-8 11" style={{ transformOrigin: "12px 12px" }} />
      </motion.svg>
    )
  },
)
