...
import { planetscaleIconData } from "../../data/cloud/planetscale.data"

export const PlanetScaleIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    {
      size = 24,
      color = "currentColor",
    ...
    const anims: AnimDef[] = [
        { selector: ".ps-orbit", keyframes: { rotate: [0, 360] }, options: { duration: 6, ease: "linear", repeat: Infinity } }
      ]
    ...
    return (
      ...
      >
        ...
        <g className="ps-orbit" style={{ transformOrigin: "12px 12px" }}>
