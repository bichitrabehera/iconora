...
import { mongodbIconData } from "../../data/cloud/mongodb.data"

export const MongodbIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    {
      size = 24,
      color = "currentColor",
    ...
    const anims: AnimDef[] = [
        { selector: ".mg-leaf", keyframes: { rotate: [-2, 2, -2] }, options: { duration: 2.5, ease: "easeInOut", repeat: Infinity } }
      ]
    ...
    return (
      ...
      >
        ...
        <g className="mg-leaf" style={{ transformOrigin: "12px 12px" }}>
        <path d="M12 3v19" />
